...
class Message {
  ...
  parse({ message }) {
    try {
      /*
       * If we're being passed a message as a string, we need to first try 
       * and JSON.parse the message to an object.
       */
      ...
      /*
       * We've experienced an error parsing the message, return false to signal 
