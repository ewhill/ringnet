      ...
      if(p.connection.connected) {
        if(p.connection.trusted) {
          ...
          /*
            ...
            the message to.
          */
          if(this.requireConfirmation && messageCopyToSend.header.type !== Message.TYPES._confirm) {
            /*
          ...
          try {
            ...
            messageCopyToSend.body = Buffer.concat([
              cipher.update(messageBodyBuffer), cipher.final()]).toString('base64');
