...
Object.prototype.getName = function() {
  let r = /function (.{1,})\(/.exec(this.constructor.toString());
...
module.exports = class Peer extends EventEmitter {
  ...
  constructor({
    ...
    if(!self.httpsServer || self.httpsServer.getName() !== "Server") {
  ...
  toString() {
    return JSON.stringify({
      'port': this.port,
      'httpsKey': this.httpsKeyLocation,
      'httpsCert': this.httpsCertLocation,
