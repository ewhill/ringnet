...
### Complete Example
Below illustrates a complete example of creating two peers, and each broadcasting a message to the other. While this sort of setup is purely exemplary, it showcases usage of the package and typical setup, etc.
```js
const { Peer, Message } = require('ringnet');
